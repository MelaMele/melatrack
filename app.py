...
# 4. Admin Report (Today's Attendance Status)
...
def get_report():
    ...
    try:
        ...
        # Left Join to get all employees and their today's status
        query = """
            SELECT 
                e.id, 
                e.full_name, 
...
def delete_employee(emp_id):
    try:
        ...
        # Delete linked attendance records first (or relies on ON DELETE CASCADE)
